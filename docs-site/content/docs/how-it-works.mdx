...
<Mermaid chart={`flowchart TB
  ...
  classDef gate  fill:#1a0b2e,stroke:#7c3aed,color:#f4f4f5,font-size:12px
  ...
  GA["Gate A — Data Contract"]:::gate
  GB["Gate B — Threat Model (STRIDE)"]:::gate
  GC["Gates C + D + F (gate-check.sh)"]:::block
  AU["audit.sh — inline prompts, secrets"]:::gate
  GE["Gate E — Red Team (optional)"]:::gate
